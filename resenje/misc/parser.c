...
{
  "$end", "error", "$undefined", "TOKEN_LIT", "TOKEN_SYMBOL",
  "TOKEN_LPAR", "TOKEN_RPAR", "TOKEN_PLUS", "TOKEN_MINUS", "TOKEN_SEMI",
...
#line 1360 "parser.c"
  ...
  case 5:
#line 62 "./resenje/misc/parser.y"
  {if(isDirective((yyvsp[0].symbol))==0){
        fprintf(stderr,"Bad directive name: %s",(yyvsp[0].symbol));
        return;
    }
